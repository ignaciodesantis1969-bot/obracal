...
import { Building2, ShieldCheck, Printer, ExternalLink, Trash2 } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <div>
            <h4 className="text-xs font-black text-slate-900 uppercase flex items-center gap-1.5">
              <Building2 className="w-4 h-4 text-amber-600" /> Certificado Avance de Obra
            </h4>
        ...
        <div id="printable-certificado-container" className="bg-white p-6 sm:p-8 rounded-2xl border-2 border-slate-800 space-y-6 text-slate-900 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs border-b border-slate-300 pb-4 bg-slate-50 p-4 rounded-xl">
            <div className="col-span-2">
              ...
              <input
                ...
                placeholder="Razón social del cliente (autocargada o editable)"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs pt-4 border-t border-slate-300">
            <div className="space-y-2 bg-white p-3 rounded-xl border border-slate-300">
              ...
              <div><span className="text-slate-500 block">Nombre:</span> <strong className="text-slate-900">{certRespProveedor.nombre}</strong></div>
              <div><span className="text-slate-500 block">Cargo:</span> <strong className="text-slate-900">{certRespProveedor.cargo}</strong></div>
            </div>
            <div className="space-y-2 bg-white p-3 rounded-xl border border-slate-300">
              <p className="font-bold text-slate-800 uppercase">Responsable Cliente</p>
              <div><span className="text-slate-500 block">Nombre:</span> <strong className="text-slate-900">{certRespCliente.nombre}</strong></div>
              <div><span className="text-slate-500 block">Cargo:</span> <strong className="text-slate-900">{certRespCliente.cargo}</strong></div>
            </div>
          </div>
        </div>
      )}
